...
Tagline: If stability is compatibility with the medium, then matter can be designed **[DOC_0 The stability of a configuration is not intrinsic to the object, but emerges from its tensional compatibility with the medium](sft-theory-and_runners/0_SFT_Document_0_Abstract_and_Orientation_UPDATED_with_10to14.pdf)** Release of SFT: a theory/framework plus a set of **runners** designed for **external audit**.
